...
<div class="container py-5 text-center">
    ...
    <div class="card mx-auto mt-4 border-0 shadow" style="max-width:420px;border-radius:16px;overflow:hidden;">
        <div class="card-header text-white fw-700" style="background:var(--primary);">رقم الطلب #{{ $order->id }}</div>
        <div class="card-body text-start">
            <p class="mb-2"><strong>Total:</strong> <span style="color:var(--primary)">{{ number_format($order->total, 0) }} DZD</span></p>
    ...
    <a href="{{ route('home') }}" class="btn text-white fw-700 mt-2 px-4" style="background:var(--primary);border-radius:10px;">← Continuer les achats</a>
</div>
@endsection
@section('scripts')
