        ...
        <div class="container">
            ...
            @foreach ($motos as $moto)
                <a href="{{ route('catalog', ['moto' => $moto->slug]) }}"
                    class="moto-tag {{ request('moto') == $moto->slug ? 'active' : '' }}"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px;margin-right:4px;"><circle cx="6" cy="17" r="2"/><circle cx="18" cy="17" r="2"/><path d="M6 17H3V11l4-5h7l2 5h3l1 3-1 3"/><path d="M14 6l1 5"/></svg>{{ $moto->name }}</a>
            @endforeach
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end mt-3 mt-md-0">
                    <p class="mb-0 fw-700" style="color:var(--primary);">الدفع عند الاستلام <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px;margin-right:4px;"><rect x="1" y="3" width="15" height="13" rx="1"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg></p>
