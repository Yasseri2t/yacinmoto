<div class="product-card h-100" style="cursor:pointer;"
    ...
    @if ($product->is_piece_of_day ?? false)
        <div class="badge-exclusive"><svg width="14" height="14" viewBox="0 0 40 40">
                <polygon points="20,6 24,15 34,16 27,23 29,33 20,28 11,33 13,23 6,16 16,15" fill="#E85D04" />
            </svg> EXCLUSIF</div>
    @endif
    @if ($product->image)
