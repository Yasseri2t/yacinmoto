                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="section" class="form-select">
                            ...
                            <option value="pieces" {{ $product->section == 'pieces' ? 'selected' : '' }}>⚙️ Pièces</option>
                            <option value="carenage" {{ $product->section == 'carenage' ? 'selected' : '' }}>🛡️ Carénage</option>
                            <option value="moteur" {{ $product->section == 'moteur' ? 'selected' : '' }}>⚡ Moteur & Électrique</option>
                        </select>
                    </div>
                    <div class="col-md-6">
