            ...
            <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="name" class="form-control" required value="{{ old('name') }}" placeholder="ex: Filtre à air Cuxi 2">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-600">Prix (DZD) *</label>
                        <input type="number" name="price" class="form-control" required value="{{ old('price') }}" step="50" min="0">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="section" class="form-select">
                            ...
                            <option value="carenage" {{ old('section') == 'carenage' ? 'selected' : '' }}>🛡️ Carénage</option>
                            <option value="moteur" {{ old('section') == 'moteur' ? 'selected' : '' }}>⚡ Moteur & Électrique</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-600">Marque</label>
                        <input type="text" name="brand" class="form-control" value="{{ old('brand') }}" placeholder="ex: Yamaha, Motul">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        <label class="form-label fw-600">Photo du produit</label>
...
document.getElementById('imgInput').addEventListener('change', function() {
    ...
    if (this.files[0]) {
        ...
        reader.onload = e => preview.innerHTML = `<img src="${e.target.result}" style="width:90px;height:90px;object-fit:contain;border-radius:8px;border:2px solid #ff6b00;background:#f8f8f8;padding:4px;">`;
