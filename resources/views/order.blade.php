    ...
    <div class="container py-4">
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-7">
                <h4 class="fw-800 mb-4"><i class="bi bi-bag-check me-2" style="color:var(--primary)"></i>Confirmer la commande
                </h4>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="customer_name" class="form-control form-control-lg" required
                                        value="{{ old('customer_name') }}" placeholder="Nom complet"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="customer_phone" class="form-control form-control-lg"
                                        required value="{{ old('customer_phone') }}" placeholder="05 XX XX XX XX"
                                        style="border-radius:10px;">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-600 small text-muted">الولاية *</label>
                                    <select name="wilaya" class="form-select form-select-lg" required
                                        style="border-radius:10px;">
                                        ...
                                        @foreach ($wilayas as $w)
                                            ...
                                            <option value="{{ trim($parts[0]) }}"
                                                {{ old('wilaya') == trim($parts[0]) ? 'selected' : '' }}>{{ $w }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="commune" class="form-control form-control-lg"
                                        placeholder="Commune" required value="{{ old('commune') }}"
                                        style="border-radius:10px;">
                                </div>
                                <div class="col-12">
...
@section('scripts')
    <script>
        ...
        (function() {
            ...
            // Always set cart data in hidden input right away
            cartInput.value = JSON.stringify(cart);

            if (!cart.length) {
                container.innerHTML =
                    '<p class="text-danger small py-2 mb-0">⚠️ Panier vide! <a href="/">Retourner au catalogue</a></p>';
